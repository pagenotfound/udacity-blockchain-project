...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(user1 == msg.sender || user2 == msg.sender, "Ownership issue");
        ...
        if(msg.sender == user1) {
            ...
            _transferFrom(user2, user1, _tokenId1);
            _transferFrom(user1, user2, _tokenId2);
        }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId) , "Sender not owner of tokenId");
